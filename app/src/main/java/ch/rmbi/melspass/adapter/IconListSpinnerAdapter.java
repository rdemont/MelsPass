...
public class IconListSpinnerAdapter extends BaseAdapter implements SpinnerAdapter {
    Activity parentActivity;

    private List<Icon> icons ;
    private Context context ;

    public IconListSpinnerAdapter(Context context, List<Icon> iconList) {
        super();
    ...
    public View getCustomView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        View rowView = inflater.inflate(R.layout.drawable_list_spinner_layout, parent, false);
